...
export const themes: Record<ThemeType, Theme> = {
  ocean: {
    ...
    primary: 'from-blue-100 via-cyan-100 to-blue-100',
  ...
  sunset: {
    name: 'Sunset Orange',
    gradient: 'from-orange-50 via-pink-50 to-orange-50',
    primary: 'from-orange-100 via-pink-100 to-orange-100',
  ...
  forest: {
    ...
    primary: 'from-green-100 via-emerald-100 to-green-100',
  ...
  midnight: {
    ...
    primary: 'from-purple-100 via-indigo-100 to-purple-100',
