...
const TextTitle: React.FC<TextTitleProps> = ({ title, icon, className="" }) => {
  return (
    <div className={`relative flex items-center text-xl gap-3 ${className} text-secondary`}>
      <div className="flex-shrink-0 drop-shadow-[0_0_12px_rgba(218,165,32,0.8)]">
        {icon}
      </div>
      
      <h2 className="font-bold tracking-wide drop-shadow-[0_0_8px_rgba(218,165,32,0.5)] text-secondary" >
        {title}
      </h2>
