  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={` flex flex-col justify-center p-8 bg gradient-to-r from-[#102A43] via-[#0D3C73] to-[#102A43]  ${isSignInPage ? "md:order-2" : "md:order-1"}   h-full `} >
...
const LoginForm: React.FC = () => {
  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={onLogin}>
      ...
      {/* Message Display */}
      <p
        className={`text-center ${isFailed ? "text-red-500" : "text-lime-500"}`}
      >
        {message || ""}
      </p>
